" ref: https://github.com/amadeus/vim-convert-color-to/blob/master/plugin/colors.vim
" author: amadeus (https://github.com/amadeus)
...
function! _self#color#convert_color_to(...) range abort
  if !&modifiable
  ...
  " Move cursor to the start of the change... not quite working on multiline
  " selects tho
