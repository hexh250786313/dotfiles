...
local source_dir = home .. "/.local/share/nvim/site/pack/packer/start/nvim-web-devicons/lua/nvim-web-devicons/default/"
...
-- 创建输出文件
local output_path = output_dir .. "icons_default.lua"
